...
const Resource = require('../dist/resources/urlSnapshotMedia/urlSnapshotMediaResource').UrlSnapshotMediaResource;

describe('UrlSnapshotMediaResource', () => {
  ...
  describe('constructor', () => {
    ...
    it('should instantiate', () => {
      ...
      expect(resource.resourceName).to.equal('UrlSnapshotMedia');
