...
const Resource = require('../dist/resources/urlSnapshotMetadata/urlSnapshotMetadataResource').UrlSnapshotMetadataResource;

describe('UrlSnapshotMetadataResource', () => {
  ...
  describe('constructor', () => {
    ...
    it('should instantiate', () => {
      ...
      expect(resource.resourceName).to.equal('UrlSnapshotMetadata');
