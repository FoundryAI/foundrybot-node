...
const Resource = require('../dist/resources/urlSnapshotTag/urlSnapshotTagResource').UrlSnapshotTagResource;

describe('UrlSnapshotTagResource', () => {
  ...
  describe('constructor', () => {
    ...
    it('should instantiate', () => {
      ...
      expect(resource.resourceName).to.equal('UrlSnapshotTag');
